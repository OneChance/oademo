...
public class MaterialListView extends RecyclerView {
    ...
    public MaterialListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        setAdapter(new MaterialListAdapter(new MaterialListView.OnSwipeAnimation() {
            @Override
        ...
        }, new MaterialListView.OnAdapterItemsChanged() {
            @Override
    ...
    public <T extends com.dexafree.materialList.view.MaterialListAdapter> void setAdapter(@NonNull final T adapter) {
